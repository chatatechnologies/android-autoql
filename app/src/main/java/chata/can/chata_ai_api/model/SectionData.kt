	...
	val mData = linkedMapOf(
		"Authentication" to
			arrayListOf(
				...
				DemoParameter("", TypeParameter.INPUT_MATERIAL, hint = "User Email", idView = R.id.etUserId, helperText = " * required"),
				...
				DemoParameter("", TypeParameter.INPUT_MATERIAL, hint = "Password", idView = R.id.etPassword, helperText = " * required"),
